  ...
  selectedWork: [
    {
      ...
      description: 'Research-led history podcast about understanding history’s “bad guys” from inside their worldview.',
    ...
    },
    {
      ...
      description: 'Founder interview show with guest strategy, production, briefing, recording and video expansion.',
    ...
    },
    {
      ...
      role: 'Lead Producer',
      description: 'Live call-in mentorship show across YouTube, TikTok Live, Instagram Live, Spotify and live audiences.',
    ...
    },
    {
      ...
      description: 'Education-sector podcast formats produced end-to-end for a large school leadership community.',
    ...
    },
    {
      ...
      description: 'Bookclub format turning leadership books into structured conversations for school leaders.',
    ...
    },
    {
      title: 'PiXL Pearls',
      role: 'Producer',
      description: 'Short-form education podcast built around concise, useful ideas for teachers and school leaders.',
    ...
    },
    {
      ...
      description: 'Developed the Blinkist Shortcast adaptation and later produced an episode with the original team.',
      ...
      <main>
        ...
        <section className="banner-wrap" aria-label="Wrong Side of History banner">
          <div className="image-shell banner-shell" aria-label="Wrong Side of History cinematic banner">
            <img src="/assets/wrong-side-of-history-banner.png" alt="Wrong Side of History cinematic banner" className="banner-image" onError={handleImageError} />
        ...
        <section className="section about-layout" id="about">
          <div className="image-shell headshot-shell" aria-label="Portrait of Jay Singleton">
            <img src="/assets/headshot.jpg" alt="Portrait of Jay Singleton" className="headshot" loading="lazy" onError={handleImageError} />
              ...
              <article className="work-card" key={project.title} role="listitem">
                <div className="image-shell">
                  <img
                    ...
                    className={`logo ${project.imageStyle === 'cover' ? 'logo-cover' : ''}`}
                    loading="lazy"
                    onError={handleImageError}
                  />
                  <div className="logo text-artwork image-fallback">{project.title}</div>
                </div>
                <h4>{project.title}</h4>
