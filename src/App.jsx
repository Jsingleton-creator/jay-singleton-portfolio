...
const content = {
  ...
  wrongSide: {
    ...
    listenLink: 'https://open.spotify.com/episode/6M9GHT2AduQ8FywaFlIv4M?si=hu2VPU__QHKyh0IXnhbZIw'
  },
  selectedWork: [
    {
    ...
    <div className="page">
      ...
      <main>
        ...
        <section className="section" id="wrong-side-of-history">
          <div className="wrong-side-content">
          ...
          <div className="wrong-side-image">
            <SmartImage
